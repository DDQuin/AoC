...
// Taken from https://www.reddit.com/r/adventofcode/comments/zsct8w/comment/j1bzuzm/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button part 2
...
func parseInputD(input []string) *board {
	var emptyLine int
